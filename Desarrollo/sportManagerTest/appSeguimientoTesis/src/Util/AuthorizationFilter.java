...
public class AuthorizationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (sesionBean != null) {
                ...
                Medico user = sesionBean.getUsuario();
    ...
    private boolean validaPermisos(String path, Medico user) {

        if ((path.equals("/protected/medico/List.xhtml") || path
                .equals("/protected/medico/Create.xhtml") || path
                .equals("/protected/medico/Edit.xhtml") || path
                .equals("/protected/medico/View.xhtml"))
