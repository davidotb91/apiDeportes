...
/**
 * SeguimientoTesis generated by hbm2java
 */
public class SeguimientoTesis implements java.io.Serializable {
	...
	public SeguimientoTesis(int segId) {
		this.segId = segId;
	}

	public SeguimientoTesis(int segId, Tema tema, Docente docente, Date segFecha, String segDocumento,
			String segPathDocumento, String segObservaciones, Integer audUsuModi, Integer audUsuCrea, Date audFechaCrea,
			Date audFechaModi) {
		this.segId = segId;
		this.tema = tema;
