...
public class EstudianteHome {
	...
	public Estudiante merge(Estudiante detachedInstance) {
		...
		try {
			Estudiante result = (Estudiante) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Estudiante findById(int id) {
		...
		try {
			Estudiante instance = (Estudiante) sessionFactory.getCurrentSession().get("entidades.Estudiante", id);
			if (instance == null) {
	...
	public List findByExample(Estudiante instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("entidades.Estudiante")
