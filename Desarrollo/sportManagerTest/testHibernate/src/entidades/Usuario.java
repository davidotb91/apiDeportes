...
public class Usuario implements java.io.Serializable {
	...
	public Usuario(int usuId, ParametroDetalle parametroDetalleByParPadCodigo,
			ParametroDetalle parametroDetalleByPadCodigo, Docente docente, String usuDescripcion, String usuLogin,
			String usuPassword, int audUsuCrea, int audUsuModi, Date audFechaCrea, Date audFechaModi) {
		this.usuId = usuId;
