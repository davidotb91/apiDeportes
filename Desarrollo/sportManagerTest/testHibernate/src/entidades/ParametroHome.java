...
public class ParametroHome {
	...
	public Parametro merge(Parametro detachedInstance) {
		...
		try {
			Parametro result = (Parametro) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Parametro findById(int id) {
		...
		try {
			Parametro instance = (Parametro) sessionFactory.getCurrentSession().get("entidades.Parametro", id);
			if (instance == null) {
	...
	public List findByExample(Parametro instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("entidades.Parametro")
