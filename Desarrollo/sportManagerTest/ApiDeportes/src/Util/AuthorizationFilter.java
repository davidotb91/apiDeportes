...
public class AuthorizationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (sesionBean != null) {
                ...
                Docente user = sesionBean.getUsuario();
    ...
    private boolean validaPermisos(String path, Docente user) {

        if ((path.equals("/protected/Docente/List.xhtml") || path
                .equals("/protected/Docente/Create.xhtml") || path
                .equals("/protected/Docente/Edit.xhtml") || path
                .equals("/protected/Docente/View.xhtml"))
