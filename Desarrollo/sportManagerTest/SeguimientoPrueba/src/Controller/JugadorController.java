	        ...
	        try {
	          //  Hibernate.initialize(current.getLugarGeografico());
	        	...
	        	/*if (getDao().verificaJugador(current)) {
	                ...
	                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Warning!", "El parámetro tiene registros asociados en tabla de Jugadors."));
	                return "";
	            }*/
...
//	        	Hibernate.initialize(current.getParametroDetalleProfesion());
	    ...
	    public SelectItem[] getItemsAvailableSelectOne() {
	        ...
	        return JsfUtil.getSelectItems(Usuarios, true, "Selecione un Catálogo");
